<?php
  ...
  /*
     Ghetto检查文件是二进制文件还是ASCII文件
      		这样我们可以确定是否可以在textarea中打印内容
      		如果文件为ascii，则返回True，否则返回False
  */
  ...
  /*
		检查数组是一个关联（散列）数组和一个简单的列表数组
      	当数组是一个关联数组时，返回True（key：value pairings）
        否则返回False
  ...
  */
  ...
  // SQLMAP Rest API客户端Communicator类
