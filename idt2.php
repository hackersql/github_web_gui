            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <label for="select_comaprison_text_only">纯文本比较:</label>
                <select class="form-control" id="select_comaprison_text_only" name="textOnly">
                  <option value="" selected="selected">禁用</option>
                  <option value="enabled">启用</option>
                </select><br />

                <label for="select_comaprison_title_only">仅页面标题比较:</label>
                <select class="form-control" id="select_comaprison_title_only" name="titles">
                  <option value="" selected="selected">禁用</option>
                  <option value="enabled">启用</option>
                </select><br />

                <label for="select_comaprison_code">匹配HTTP状态代码为True:</label>
                <select class="form-control" id="select_comaprison_code" name="comaprison_code">
                  <option value="" selected="selected" onClick="divHideAndSeek('display_comaprison_code_data_form', 1)">禁用</option>
                  <option value="enabled" onClick="divHideAndSeek('display_comaprison_code_data_form', 0)">启用</option>
                </select>
                <div id="display_comaprison_code_data_form" align="central" style="display: none">
                  <br />
                  <label for="request_comaprison_code">HTTP状态码匹配:</label>
              ...
              <div class="col-md-5">
                <label for="select_comaprison_str">设置自定义字符串匹配True:</label>
                <select class="form-control" id="select_comaprison_str" name="comaprison_str">
                  <option value="" selected="selected" onClick="divHideAndSeek('display_comaprison_str_data_form', 1)">禁用</option>
                  <option value="enabled" onClick="divHideAndSeek('display_comaprison_str_data_form', 0)">启用</option>
                </select>
                <div id="display_comaprison_str_data_form" align="central" style="display: none">
                  <br />
                  <label for="request_comaprison_str">字符串匹配为True:</label>
                ...
                <label for="select_comaprison_not_str">设置自定义字符串匹配 False:</label>
                <select class="form-control" id="select_comaprison_not_str" name="comaprison_not_str">
                  <option value="" selected="selected" onClick="divHideAndSeek('display_comaprison_not_str_data_form', 1)">禁用</option>
                  <option value="enabled" onClick="divHideAndSeek('display_comaprison_not_str_data_form', 0)">启用</option>
                </select>
                <div id="display_comaprison_not_str_data_form" align="central" style="display: none">
                  <br />
                  <label for="request_comaprison_not_str">字符串匹配为False:</label>
                ...
                <label for="select_comaprison_regex">设置自定义 Regex模式以匹配True:</label>
                <select class="form-control" id="select_comaprison_regex" name="comaprison_regex">
                  <option value="" selected="selected" onClick="divHideAndSeek('display_comaprison_regex_data_form', 1)">禁用</option>
                  <option value="enabled" onClick="divHideAndSeek('display_comaprison_regex_data_form', 0)">启用</option>
                </select>
                <div id="display_comaprison_regex_data_form" align="central" style="display: none">
                  <br />
                  <label for="request_comaprison_regex_str">正则表达式匹配为True:</label>
